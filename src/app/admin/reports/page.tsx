...
export default function ReportsPage() {
    ...
    async function load() {
        ...
        try {
            ...
            // אם זה לא JSON – נציג שגיאה ברורה
            ...
            <div className="mx-auto max-w-5xl p-6">
                <div className="flex items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            className={`rounded-full border px-4 py-2 text-sm font-bold ${status === "open" ? "bg-black text-white" : "bg-white"
                                }`}
                        ...
                        <button
                            className={`rounded-full border px-4 py-2 text-sm font-bold ${status === "resolved" ? "bg-black text-white" : "bg-white"
                                }`}
